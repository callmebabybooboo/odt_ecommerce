...
ActiveRecord::Schema[8.0].define(version: 2025_04_26_185300) do
  ...
  create_table "solid_queue_jobs", force: :cascade do |t|
    ...
    t.index ["queue_name", "priority", "run_at"], name: "index_solid_queue_jobs_on_queue_priority_run"
  end
